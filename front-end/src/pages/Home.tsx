    ...
    >
      ...
      <div
        className="
          ...
          bg-[#000000da] w-full gap-5 py-4 px-4 "
      >
        <InfoCard
          Iconn={Iconn}
          title="Paste your link"
          description="Drop your YouTube, TikTok, or Instagram link into the box."
        />
        <InfoCard
          Iconn={Iconn}
          title="ClipDrop fetches the media"
          description="We instantly detect the source and prepare your video or audio for download."
        />
        <InfoCard
          Iconn={Iconn}
          title="Download instantly"
          description="Choose your desired quality and download instantly—no ads, no limits."
        />
        <InfoCard
          Iconn={Iconn}
          title="Enjoy and share"
          description="Your downloaded content is ready to use or share across any platform."
        />
      </div>
    </div>
  );

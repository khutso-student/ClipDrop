...
export default function Signup({ model, setModel, switchToLogin }: SignupProps) {
  ...
  return (
    <div>
    <button onClick={() => setModel(!model)} className="bg-gradient-to-r from-[#000B15] to-[#001D33] text-white text-sm hover:text-[#EE6767] px-4 sm:px-6 py-1.5 border border-[#2E4657] hover:border-[#EE6767] rounded-lg hover:opacity-90 transition duration-300 cursor-pointer" > 
        Sign Up 
    </button>
        ...
        >
          ...
          >
            <div className="hidden sm:flex justify-center items-center h-full w-70">
              <img src={ClipDrop} alt="Signup Logo" className="h-80" />
            </div>
            ...
            <div className="flex flex-col justify-center items-center h-full w-full sm:w-80 border-l-2 border-[#000] sm:border-[#2E4657] rounded-md p-4">
              ...
              <div className="flex gap-2 justify-center items-center w-full text-white text-sm">
                <p>Have account? </p>
                <span
                  className="font-semibold text-white hover:text-[#EE6767] cursor-pointer"
                  onClick={() => {
                    setModel(false);
                    switchToLogin();
                  }}
              ...
              <div className="flex justify-center items-center w-full text-[#686666] mt-8 text-sm">
                <p>&copy; {new Date().getFullYear()} ClipDrop. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
